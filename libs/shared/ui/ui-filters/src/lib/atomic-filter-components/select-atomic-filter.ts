...
import {
  ...
  SelectFilterValue,
} from '../atomic-filter-controllers/select-filter.controller';
...
export class SelectAtomicFilterComponent {
  ...
  // checkboxChange($event: MatCheckboxChange, requirement: SelectFilterValue) {
  //   const currentValue = this._selectFilterFormValue();
  //   let newValue: SelectFilterValue[];
  //   if ($event.checked) {
  ...
  //     );
  //   }
  //   this._selectFilterFormValue.set(newValue);
